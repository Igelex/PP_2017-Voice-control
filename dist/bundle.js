...
window.onload = function () {
  ...
  (0, _jquery.default)('#start-search').click(function () {
    checkInputMode((0, _jquery.default)('#search-input').val());
  });
  (0, _jquery.default)('html, body').click(function () {
  ...
  function checkInputMode(input) {
    ...
    if (inputMode === _const.MODE_NO_MODE) {
      switch (true) {
        ...
        case _const.REG_EXP_CHECK.test(userCommand):
          ...
          if (result) {
            ...
            searchForCheckboxesAndRadios(_const.CHECK_SELECTORS, result);
          }
      ...
      var textContent = (0, _jquery.default)(selectedInputField).val();
      ...
      (0, _jquery.default)(selectedInputField).val(textContent);
  ...
  function searchForInputFields(selector, userInput) {
    ...
    var selectedElements = (0, _jquery.default)(selector);
    var elem;
    ...
    if (selectedElements.length > 0) {
      ...
      if (elements.length === 1) {
        if ((0, _jquery.default)(elements).is('label')) {
          selectedInputField = (0, _jquery.default)(elements).next();
          selectedInputField.focus();
          changeInputMode(_const.MODE_TYPE);
        } else {
          selectedInputField = (0, _jquery.default)(elements);
          selectedInputField.focus();
          changeInputMode(_const.MODE_TYPE);
        }
      } else {
  ...
  function changeInputMode(newInputMode) {
    ...
    if (inputMode !== _const.MODE_TYPE) {
      (0, _jquery.default)(selectedInputField).blur();
      selectedInputField = null;
    }
  ...
  function scrollDown() {
    (0, _jquery.default)('html, body').animate({
      scrollTop: (0, _jquery.default)(window).scrollTop() + window.innerHeight / 2
    });
  }
  ...
  function isVisible(elem) {
    var top_of_element = (0, _jquery.default)(elem).offset().top;
...
* */
function _default() {//let scriptJquery = document.createElement('script');
